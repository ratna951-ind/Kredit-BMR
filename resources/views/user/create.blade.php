                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 mx-auto">
                                            <input type="text" id="inputNama" class="form-control border-primary" placeholder="Masukan Nama" name="nama" autofocus>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 mx-auto">
                                            <input type="text" id="inputUsername" class="form-control border-primary" placeholder="Masukan Username" name="username">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-9 mx-auto">
                                            <select class="form-control" id="inputKios" name="kode_kios">
                                                ...
                                                @foreach($kioss as $kios)
                                                    <option value="{{$kios->kode}}">{{$kios->nama}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
